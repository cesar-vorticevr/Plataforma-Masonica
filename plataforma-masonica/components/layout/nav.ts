...
import { unreadMensajes, nuevosEventos } from "@/lib/data/store";

export interface NavItem { href: string; label: string; icon: string; show: (u: Usuario) => boolean; badge?: (u: Usuario) => number; }
...
export const NAV: NavItem[] = [
  ...
  { href: "/mensajes", label: "Mensajes", icon: "✉️", show: u => accesoCompleto(u), badge: u => unreadMensajes(u.id) },
