...
import { contarEventosNuevos } from "@/lib/data/eventos";
...
export const NAV: NavItem[] = [
  ...
  { href: "/cumplimientos", label: "Cumplimientos", icon: "✅", show: u => accesoCompleto(u) },
  ...
  { href: "/eventos", label: "Eventos", icon: "📅", show: u => accesoCompleto(u), badge: () => contarEventosNuevos(createClient()) },
