...
export async function listMensajes(sb: SupabaseClient): Promise<MensajeProfesional[]> {
...
export async function enviar(
  sb: SupabaseClient, deId: string, deNombre: string, aId: string, aNombre: string, cuerpo: string,
...
export async function marcarLeidos(sb: SupabaseClient, deId: string): Promise<void> {
  await sb.rpc("marcar_mensajes_leidos", { p_de: deId });
}

export async function contarNoLeidos(sb: SupabaseClient, userId: string): Promise<number> {
